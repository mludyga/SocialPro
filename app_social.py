...
if 'selected_pexels_url' not in st.session_state:
...
with auto_tab:
    ...
    if st.button("Pobierz artykuły i wygeneruj posta AI"):
        ...
        if not articles:
            ...
            with st.spinner("Krok 2/5: AI analizuje, który artykuł jest najciekawszy..."):
                ...
                st.session_state.article_title_for_pexels = chosen_article['title']
            ...
            with st.spinner("Krok 4/5: Pobieranie i weryfikacja obrazka wyróżniającego..."):
                ...
                if image_url:
                    ...
                    try:
                        ...
                        st.session_state.featured_image_bytes = None # Upewniamy się, że tu jest None
    ...
    if st.session_state.generated_post:
        ...
        with img_tab1:
            ...
            if st.session_state.featured_image_url:
                if st.session_state.featured_image_bytes:
                    ...
                    st.warning("Nie udało się automatycznie pobrać podglądu obrazka (prawdopodobnie z powodu zabezpieczeń serwera).")
                st.markdown(f"**Link do obrazka (do ręcznego sprawdzenia):** [{st.session_state.featured_image_url}]({st.session_state.featured_image_url})")
            else:
